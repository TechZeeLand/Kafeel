...
<div class="admin-shell">
  <aside class="admin-sidebar">
    <a href="/admin/index.php" class="brand"><span class="mark">ك</span> <?= e(store_info()['name']) ?></a>
    <nav>
  ...
  <div class="admin-main">
    ...
    <div class="admin-content">
      <?php if (!empty($GLOBALS['__migration_error'])): ?>
        <div class="alert alert-error"><strong>Database upgrade failed:</strong> <?= e($GLOBALS['__migration_error']) ?> — run <code>sql/migrations/004_phase4.sql</code> manually (phpMyAdmin) and reload.</div>
      <?php endif; ?>
