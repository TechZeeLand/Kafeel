...
function social_icon(string $key, int $size = 18): string {
    static $paths = [
        ...
        'signal' => '<path fill-rule="evenodd" d="M12.04 2C6.5 2 2 6.13 2 11.24c0 2.9 1.42 5.49 3.66 7.22-.02.32-.14 1.2-.43 2.39a.75.75 0 0 0 1 .9c1.44-.55 2.39-.99 2.9-1.24a11 11 0 0 0 2.9.4c5.54 0 10.03-4.13 10.03-9.24S17.58 2 12.04 2zm0 3.6a5.63 5.63 0 1 1 0 11.26 5.63 5.63 0 0 1 0-11.26zm0 2.1a3.53 3.53 0 1 0 0 7.06 3.53 3.53 0 0 0 0-7.06z"/>',
    ];
