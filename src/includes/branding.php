...
function social_icon(string $key, int $size = 18): string {
    static $paths = [
        ...
        'signal' => '<path fill-rule="evenodd" d="M12 2C6.477 2 2 6.477 2 12c0 2.02.6 3.9 1.63 5.48L2.5 22l4.52-1.13A9.95 9.95 0 0 0 12 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm0 2a8 8 0 0 1 8 8c0 4.418-3.582 8-8 8a7.94 7.94 0 0 1-4.02-1.09l-.7-.42-2.43.61.61-2.43-.42-.7A7.94 7.94 0 0 1 4 12a8 8 0 0 1 8-8zm-4.1 5.1c-.22 0-.4.18-.4.4 0 2.82 2.28 5.1 5.1 5.1.22 0 .4-.18.4-.4s-.18-.4-.4-.4a4.3 4.3 0 0 1-4.3-4.3c0-.22-.18-.4-.4-.4zm1.7 0c-.22 0-.4.18-.4.4a3.4 3.4 0 0 0 3.4 3.4c.22 0 .4-.18.4-.4s-.18-.4-.4-.4a2.6 2.6 0 0 1-2.6-2.6c0-.22-.18-.4-.4-.4z"/>',
    ];
...
function social_row_html(string $class = 'social-row'): string {
    $links = array_intersect_key(store_socials(), array_flip(['facebook', 'instagram', 'youtube', 'whatsapp', 'signal']));
    if (!$links) return '';
    $h = '<div class="' . e($class) . '">';
